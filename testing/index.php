...
?>
	...
	<section class="full-height section-intro" id="intro" style="background-image: url(perch/resources/m-e-wlng.jpeg);">
		...
		<header>
		    ...
		    <div id="header-bottom">
			   	<h2>
			   		<a href="https://www.caravanrestaurants.co.uk/perch/resources/admin/caravan-private-hire-04-01-19.pdf" target="_blank" class="bottom-img">Private hire & events</a>
				</h2>
		    </div>
		</header>
